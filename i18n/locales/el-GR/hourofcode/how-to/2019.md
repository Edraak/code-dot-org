...
- Βεβαιωθείτε ότι έχετε δοκιμάσει τα μαθήματα-οδηγούς στους υπολογιστές ή τις συσκευές των μαθητών, και ότι λειτουργούν κανονικά στους φυλλομετρητές με ήχο και βίντεο.  Have low bandwidth? Plan to show videos at the front of the class, so each student isn't downloading their own videos. Or try the offline tutorials.
