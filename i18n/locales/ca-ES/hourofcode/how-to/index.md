...
### Uneix-te al moviment i introdueix a un grup d'estudiants en la seva primera hora d'informàtica amb aquests passos. L'Hora del Codi és fàcil d'utilitzar - fins i tot per a principiants! If you'd like an extra set of hands to help out, you can find a [local volunteer]({{ urls/volunteer_local }}) to help run an Hour of Code in your class.
