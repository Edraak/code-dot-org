...
### یک ساعت کد را در خانه انجام دهید، یا داوطلب شوید که آن را به کلاس درس فرزندتان ببرید! 
...
## 2. یک برنامه ی آموزشی را انتخاب کنید:
...
بهترین تجربه ساعت کدنویسی با کامپیوترهای متصل به اینترنت می باشد. اما شما نیازی به کامپیوتر**ندارید**. بسیاری از فعالیت ها "خاموش" هستند، و بدون داشتن برق و یا دسترسی به هر گونه تکنولوژی قابل اجرا می باشند. برنامه های آموزشی را روی کامپیوتر و یا دستگاهتان امتحان کنید. مطمئن شوید که بر روی مرورگرتان به خوبی و به همراه صدا و تصویر کار کنند.

**آیا می خواهید همزمان با فرزندتان یادبگیرید؟**[ برنامه نویسی دونفره](http://www.ncwit.org/resources/pair-programming-box-power-collaborative-learning) را آزمایش کنید. علوم کامپیوتر شراکتی و اجتماعی است.

## 5) ساعت کد نویسی خودتان را با یک فیلم الهام بخش شروع کنید
...
- راهای تاثیرگزاری تکنولوژی بر زندگی ما را توضیح دهید، با مثال هایی که هم دخترها و هم پسرها به آنها علاقمند هستند (بحث در مورد نجات زندگی اشخاص، کمک به مردم، ایجاد ارتباط بین مردم، و غیره).
...
گواهینامه ها را برای فرزندتان (و خودتان!) [ چاپ کنید](%= resolve_url('https://code.org/certificates') %).
...
[پرسش و پاسخ ساعت کد](https://help.edraak.org/hc/en-us/categories/200147083-Hour-of-Code) را مرور کنید.

## مرحله بعد از ساعت كدنويسي چيست؟

ساعت کدنویسی تنها اولین گام در مسیر کسب اطلاعات بیشتر در مورد چگونگی کارکردتکنولوژی و نحوه ایجاد نرم افزارهای کاربردی است. برای ادامه این مسیر:

- Encourage your child to continue [to learn online]({{ urls/learn_beyond }}).
- به [ترویج](%= resolve_url('/promote') %) آموزش علوم کامپیوتر در منطقه مدرسه فرزندتان کمک کنید.
