...
module Dashboard
  class Application < Rails::Application
    ...
    Rails.application.routes.default_url_options[:host] = CDO.canonical_hostname('code.edraak.org')
    ...
    config.i18n.available_locales = ['ar-SA']
    config.i18n.fallbacks[:defaults] = ['ar-SA']
    config.i18n.default_locale = 'ar-SA'
    ...
    config.action_mailer.default_url_options = {host: CDO.canonical_hostname('code.edraak.org'), protocol: 'https'}
